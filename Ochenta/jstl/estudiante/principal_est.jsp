...
<body>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <div class="module estudiante">
            <a href="../estudiante/Subir-Anteproyecto/mostrarEstudiante.jsp">
                <img class="img" src="../../img/subir.png" alt="Administrador">
                <h2>SUBIR TAREA</h2>
            </a>
        </div>

        <div class="module docente">
            <a href="../estudiante/informe/mostrarEstudiante.jsp">
                <img class="img" src="../../img/notas.png" alt="Docente">
                <h2>VER CALIFICACION</h2>
            </a>
        </div>
