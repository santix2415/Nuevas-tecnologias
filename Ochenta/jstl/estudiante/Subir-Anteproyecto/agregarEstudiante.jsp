...
<html lang="en">
    ...
    <body class="body">
        ...
        <c:if test="${param.est_fecha == null}" >
                ...
                <h1 class="titulo">Subir Anteproyecto Estudiante</h1><br>
                    <fieldset>
                        ...
                        <div class="form-group">
                                ...
                                <input type="file" class="form-control" required id="est_archivo" name="est_archivo" value="${fila.est_archivo}" required>
                            </div>

                            <div class="form-group">
                                <label for="fecha">Fecha Entrega:</label>
                                <input type="date" class="form-control" id="est_fecha" name="est_fecha" value="${fila.est_fecha}" required>
                            </div>
        ...
        <c:if test="${param.est_fecha !=null}" >
            ...
            UPDATE estudiante
            SET est_archivo = '${param.est_archivo}',
                est_fecha = '${param.est_fecha}',
                id_evaluador = '${param.id_evaluador}'
            WHERE id = '${param.id}';
        </sql:update>
            <c:if test="${result == 1}" >
                <script>
