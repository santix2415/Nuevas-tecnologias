...
<head>
    ...
    <style>
        ...
        <body class="body"> <br>
            ...
            <h2 class="subtitulo">Datos del Estudiante</h2>        
        ...
        <fieldset class="contenedor"> 
                    ...
                    <tbody style="background-color:white">
                        <c:forEach var="fila" items="${result.rows}">
                            <tr>
                                ...
                                <td><c:out value="${fila.est_contra}" /></td>
            ...
            <nav class="navbar navbar-expand-lg" style="display: flex; justify-content: center; align-items: center;">
                    <button id="boton1" class="btn btn-success rounded-pill" type="button" onclick="location.href='agregarEstudiante.jsp?id=${fila.id}'">Nuevo Estudiante</button>
