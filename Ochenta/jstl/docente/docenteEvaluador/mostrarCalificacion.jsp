...
<!DOCTYPE html>
    <html lang="en">
        <head>
            ...
            <title>Calificacion Docente Evaluador</title>
             <style>
        body {
        ...
        <body class="body"> <br>
            <h1 class="titulo"></h1>
            <h2 class="subtitulo"> Calificacion Docente Reemplazo</h2>        
            ...
            <sql:query var="result" scope="request" dataSource="${parcialjstl}">
                ...
                WHERE aprobar_proyecto.estado = 'aprobado';
        ...
        <fieldset class="contenedor"> 
            ...
            <nav class="navbar navbar-expand-lg" style="display: flex; justify-content: center; align-items: center;">
                    <button id="boton2" class="btn btn-secondary rounded-pill" type="button" onclick="location.href='../principal_eval.jsp'">Regresar</button>
            </nav>
        </fieldset>
        <br>
