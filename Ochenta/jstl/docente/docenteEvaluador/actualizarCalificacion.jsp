    ...
    <body class="body">
        ...
        <nav class="navbar navbar-expand-sm  navbar-dark fixed-top">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                <button id="boton2" class="btn btn-outline-secondary rounded-pill" type="button" onclick="location.href='../principal_eval.jsp'">Regresar</button>
                </li>
            </ul>
        </nav>
                ...
                <sql:query var="universidad" dataSource="${parcialjstl}">
                    ...
                    <form method=post>
                        <c:forEach var="itema" items="${universidad.rows}">
                            ...
                            <h1 class="titulo">Calificacion del proyecto aprobado por el Director</h1>
                    <fieldset>
