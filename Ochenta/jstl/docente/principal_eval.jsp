...
<body>
    ...
    <h1 style="color:white;">Docente Remplazo</h1>
    <ul class="navbar-nav ml-auto">
        ...
        <div class="module estudiante">
            <a href="../docente/docenteEvaluador/mostrarCalificacion.jsp">
                <img class="img" src="../../img/lupa.png" alt="Administrador">
                <h2>CALIFICACION DE TAREAS REMPLAZO</h2>
            </a>
        </div>
