...
<!DOCTYPE html>
    <html lang="en">
        ...
        <body class="body"> <br>
            ...
            <h2 class="subtitulo">Informe Docente Principal</h2>        
            ...
            <sql:query var="result" scope="request" dataSource="${parcialjstl}">
                ...
                FROM estudiante e
                INNER JOIN docentes d ON e.id_director = d.id
                    ...
                    <tbody style="background-color:white">
                        <c:forEach var="fila" items="${result.rows}">
                            <tr>
                                ...
                                <td><c:out value="${fila.id_director} ${fila.doc_nombre} ${fila.doc_apellidos}" /></td>
