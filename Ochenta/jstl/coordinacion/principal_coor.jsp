...
<body>
    ...
    <div class="container-fluid">
        <div class="module estudiante">
            <a href="../coordinacion/Crud-Anteproyecto/mostrarIdeaProyecto.jsp">
                <img class="img" src="../../img/idea.png" alt="Administrador">
                <h2>TAREAS DEL ESTUDIANTE</h2>
            </a>
        </div>

        <div class="module docente">
            <a href="../coordinacion/Consulta/consultaAnteproyectos.jsp">
                <img class="img" src="../../img/investigar.png" alt="Docente">
                <h2>CONSULTA TAREA PARA EL ESTUDIANTE</h2>
            </a>
        </div>
